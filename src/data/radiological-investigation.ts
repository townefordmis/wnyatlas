...
export const radiologicalProducers: RadiologicalProducer[] = [
  {
    ...
    evidence: "documented",
    summary: "NIOSH documents a 1955 AEC pilot melt of 70 pounds of uranium-contaminated stainless-steel and aluminum scrap at TAM and separately documents bench-scale uranium-compound work in July 1956. Survey tables identify slag from the melt. No reviewed public record establishes where that experimental slag was ultimately placed, so WNY Atlas does not connect it to a later fill site.",
  ...
  },
  {
    ...
    evidence: "documented",
    summary: "New York State Archives records describe EAD's approximately 1977-1983 manufacture of smoke-detector foil elements and the release of americium-241 into the sanitary sewer, contaminating sewer lines, the sewage-treatment plant, and landfill. This is a distinct sewer-system pathway and is not evidence about Linde uranium residues or Niagara County slag fill.",
...
export const radiologicalDocuments: RadiologicalDocument[] = [
  {
    ...
    geography: "Niagara",
    status: "final",
    establishes: "Documents the 1955 pilot remelt of 70 pounds of uranium-contaminated scrap, slag produced by that melt, and separate July 1956 bench-scale uranium-compound work. NIOSH found dose reconstruction feasible for the evaluated 1955-1956 class and proposed no SEC addition.",
