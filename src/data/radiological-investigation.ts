...
export const radiologicalProducers: RadiologicalProducer[] = [
  {
    ...
    role: "processor",
    county: "Niagara",
    location: "Niagara Falls; former 35-acre manufacturing complex",
    evidence: "documented",
    relatedSiteId: "tam-ceramics-niagara",
    summary: "NIOSH documents a 1955 AEC pilot melt of 40 pounds of uranium-contaminated stainless steel and 30 pounds of aluminum shipped from Mallinckrodt, containing about 90 grams of uranium in total. Input material reached 26,800 dpm/100 cm² surface contamination, and survey tables identify slag from the melt. Separate bench-scale uranium-compound work occurred July 10-11, 1956. No reviewed public record establishes where the experimental slag was ultimately placed, so WNY Atlas does not equate it with later fill.",
    sourceLabel: "NIOSH SEC-00190 evaluation for Titanium Alloys Manufacturing",
    sourceUrl: "https://www.cdc.gov/niosh/ocas/pdfs/sec/titanalloy/titanpeter-190-r0.pdf",
  },
  {
    id: "ead-metallurgy-americium",
    name: "EAD Metallurgy Am-241 foil operation",
    role: "processor",
    county: "Erie",
    location: "71 Pearce Avenue, Town of Tonawanda",
    evidence: "documented",
    relatedSiteId: "ead-metallurgy-americium",
    summary: "New York State Archives and federal cleanup records describe EAD's approximately 1977-1983 manufacture of smoke-detector foil elements and the release of americium-241 into the sanitary sewer. The americium accumulated in treatment sludge, was incinerated, and reached the municipal landfill. This is a distinct sewer/sludge pathway and is not evidence about Linde uranium residues or Niagara County slag fill.",
    sourceLabel: "New York State Archives series 20691 finding aid",
    sourceUrl: "https://findingaids.nysed.gov/do/a1bb63f9-e4a2-5676-8c2c-7c944838ec53",
  },
  {
...
export const radiologicalDocuments: RadiologicalDocument[] = [
  {
    ...
    geography: "Niagara",
    status: "final",
    establishes: "Documents the 1955 pilot remelt of 40 pounds of uranium-contaminated stainless steel and 30 pounds of aluminum from Mallinckrodt, approximately 90 grams of uranium in total, a maximum input-material surface reading of 26,800 dpm/100 cm², slag produced by the melt, and separate July 10-11, 1956 bench-scale uranium-compound work. NIOSH found dose reconstruction feasible for the evaluated 1955-1956 class and proposed no SEC addition.",
    mapConnection: "Confirms a small, time-bounded radiological operation at TAM. It does not document the experimental slag's ultimate destination or connect TAM to a particular residential fill site.",
    url: "https://www.cdc.gov/niosh/ocas/pdfs/sec/titanalloy/titanpeter-190-r0.pdf",
  },
  {
    id: "carborundum-site-profile-2020",
    title: "Site Profile for The Carborundum Company",
    agency: "CDC/NIOSH",
    date: "April 23, 2020",
    year: 2020,
    kind: "worker-record",
    geography: "Niagara",
    status: "final",
    establishes: "Documents experimental grinding of ten uranium slugs in 1943 and a separate AEC fuel-development program from 1959 through 1967 involving uranium and uranium/plutonium materials.",
    mapConnection: "Strengthens the Carborundum facility history while leaving any claimed off-site waste or fill destination unproven unless a shipment, disposal, or analytical record is found.",
    url: "https://www.cdc.gov/niosh/ocas/pdfs/tbd/carbco-r0-508.pdf",
  },
  {
    id: "ead-metallurgy-archives-20691",
    title: "Radioactive Waste Site Records - EAD Metallurgy cleanup files",
    agency: "New York State Archives / New York State Department of Health",
    date: "Records dated 1982-1995",
    year: 1995,
    kind: "cleanup-decision",
    geography: "Erie",
    status: "historical",
    establishes: "The official finding aid records that EAD manufactured Am-241 smoke-detector foil elements circa 1977-1983 and released Am-241 to the Town of Tonawanda sanitary sewer, contaminating sewer lines, the sewage-treatment plant, and landfill. The state certified the property for future use in 1995 under applicable radiological guidelines.",
    mapConnection: "Adds a separate Tonawanda liquid/sewer and municipal-waste pathway. It must not be conflated with the older Linde/FUSRAP uranium network.",
    url: "https://findingaids.nysed.gov/do/a1bb63f9-e4a2-5676-8c2c-7c944838ec53",
  },
  {
    id: "ead-metallurgy-cleanup-1987",
    title: "Cleanup of Americium-241 Contamination at EAD Metallurgical and the Town of Tonawanda Sewer System",
    agency: "New York State Department of Health / federal administrative-record copy",
    date: "January 19, 1987",
    year: 1987,
    kind: "cleanup-decision",
    geography: "Erie",
    status: "historical",
    establishes: "Records EAD's Am-241 smoke-detector foil operation, unsuccessful initial building decontamination attempts, and the discovery of Am-241 in the sanitary sewer leading from the facility.",
    mapConnection: "Primary administrative-history support for the EAD building and sewer pathway; it is separate from the Linde/FUSRAP uranium source history.",
    url: "https://lmpublicsearch.lm.doe.gov/SiteDocs/T-378.pdf",
  },
  {
    id: "tonawanda-landfill-ead-americium-1994",
    title: "Tonawanda Landfill Radiological Investigation Work Plan",
    agency: "U.S. Department of Energy administrative record",
    date: "September 1994",
    year: 1994,
    kind: "audit-review",
    geography: "Erie",
    status: "historical",
    establishes: "Explains that Am-241 released by EAD entered the sanitary sewer, concentrated in sewage-treatment sludge, passed through the municipal sludge incinerator, and was deposited in the eastern landfill. It reports 1988 characterization finding Am-241 as deep as seven feet in the identified landfill areas.",
    mapConnection: "Documents the sewer-to-sludge-to-incinerator-to-landfill route while distinguishing it from older Linde-related radionuclides found at the same broader landfill property.",
    url: "https://lmpublicsearch.lm.doe.gov/SiteDocs/T-335.pdf",
  },
  {
    id: "doe-linking-legacies-1997",
    title: "Linking Legacies: Connecting the Cold War Nuclear Weapons Production Processes to Their Environmental Consequences",
    agency: "U.S. Department of Energy, Office of Environmental Management",
    date: "January 1997",
    year: 1997,
    kind: "audit-review",
    geography: "Erie and Niagara",
    status: "historical",
    establishes: "Provides a federal process-to-waste framework for understanding how nuclear-weapons production generated environmental residues and cleanup obligations across the national complex.",
    mapConnection: "Research reference and interpretive framework; it is not a complete property inventory and does not itself establish a WNY disposal route.",
    url: "https://www.osti.gov/biblio/353361",
  },
  {
    id: "doe-fusrap-background-1980",
    title: "Background Report for the Formerly Utilized Manhattan Engineer District/Atomic Energy Commission Sites Program",
    ...
    geography: "Erie and Niagara",
    status: "historical",
    establishes: "Documents the early federal FUSRAP site-review framework and preserves historical facility context that can be compared with later eligibility, survey, and cleanup decisions.",
    mapConnection: "Core research reference; a facility's appearance or omission is not by itself proof of contamination, disposal, or cleanup status.",
    url: "https://www.osti.gov/biblio/6809789",
  },
  {
    id: "abbott-road-slag-assessment-2025",
    title: "Abbott Road Reconstruction Draft Initial Project Proposal / Final Design Report",
    agency: "Erie County Department of Public Works",
    date: "December 5, 2025",
    year: 2025,
    kind: "current-assessment",
    geography: "Erie",
    status: "ongoing",
    establishes: "Record plans and 1990 and 2025 borings indicate slag beneath Abbott Road and around the Smoke Creek bridge abutments. The consultant recommends radiological screening and possible laboratory analysis for TENORM if elevated field readings are found.",
    mapConnection: "Supports the Southtowns investigation chapter as documented slag-infrastructure evidence. It does not establish that the Abbott Road slag is radioactive, so no contamination marker is drawn.",
    url: "https://www3.erie.gov/dpw/sites/www3.erie.gov.dpw/files/2026-01/5764.15-abbott-rd-draft-ippfdr-december-5-2025_2.pdf",
  },
  {
    id: "riverbend-tenorm-2016",
    title: "RiverBend Area I TENORM Reuse Work Plan",
    agency: "Benchmark Environmental for Fort Schuyler Management; filed with NYSDEC",
    date: "May 2016",
    year: 2016,
    kind: "cleanup-decision",
    geography: "Erie",
    status: "final",
    establishes: "Documents the 2015 recycling-facility radiation alarm and identifies subsurface iron- and steelmaking slag at former Republic Steel as the source of low-level TENORM, with radium-226 as the principal isotope.",
    mapConnection: "Proves a radiological slag finding at former Republic Steel. It does not prove that TENORM-bearing material entered Buffalo Slag's historical construction products.",
  ...
  {
    id: "hamburg-no-slag-1989",
    title: "Lincoln Square Apartments Site Plan Review - NO SLAG Instruction",
    agency: "Town of Hamburg Engineering Department",
    date: "March 8, 1989",
    year: 1989,
    kind: "worker-record",
    geography: "Erie",
    status: "historical",
    establishes: "Directs the project designer to specify no slag in all details and to use stone in the Town right-of-way. The review gives no reason for the restriction.",
    mapConnection: "Documents a Town engineering instruction, not a radiological finding. It is retained as a policy-history lead and does not support a radiation marker.",
    url: "https://www.townofhamburgny.gov/Archive/ViewFile/Item/868",
  },
  {
    id: "buffalo-slag-steelawanna-1988",
    title: "Preliminary Site Characterization - Buffalo Slag / Buffalo Crushed Stone, Steelawanna Avenue",
    agency: "Recra Environmental for New York State Department of Transportation",
    date: "November 1988",
    year: 1988,
    kind: "audit-review",
    geography: "Erie",
    status: "historical",
    establishes: "Reports that Buffalo Slag operated the site from about 1913 to 1983 and processed slag from Hanna Furnace and Republic Steel for road base, embankment fill, and other construction uses.",
    mapConnection: "Establishes the historical processor and supply-chain link without characterizing the distributed product as TENORM.",
    url: "https://extapps.dec.ny.gov/data/DecDocs/V00319/Report.VCP.V00319.1988-11-01.Preliminary_Site_Characterization_Steelwanna_Ave-Buffalo_and_Lackawanna--Recra_Environmental-ocr.pdf",
  },
  {
    id: "hanna-furnace-slag-distribution-1988",
    title: "Hanna Furnace Site Characterization and Environmental Assessment",
    agency: "Recra Environmental; filed with NYSDEC",
    date: "August 22, 1988",
    year: 1988,
    kind: "audit-review",
    geography: "Erie",
    status: "historical",
    establishes: "Reports that Buffalo Slag purchased and removed accumulated Hanna Furnace slag, recovered entrained iron, and sold the remaining material for road-making bases or railroad ballast.",
    mapConnection: "Documents the Hanna-to-Buffalo-Slag distribution chain. It is not a radiological analysis of the sold product.",
    url: "https://extapps.dec.ny.gov/data/DecDocs/915029/Report.HW.915029.1988-08-22.Site_Characterization_and_Environmental_Assessment-Vol_%20I--Recra_Environmental-ocr.pdf",
  },
  {
    id: "boston-buffalo-slag-bid-1983",
    title: "Town of Boston Road-Material Bid - Buffalo Slag Woodlawn Plant No. 81",
    agency: "Town of Boston",
    date: "1983",
    year: 1983,
    kind: "worker-record",
    geography: "Erie",
    status: "historical",
    establishes: "Lists multiple crushed blast-furnace slag and crusher-run products offered from Buffalo Slag's Woodlawn plant in Hamburg, including delivered prices and claimed NYSDOT specification compliance.",
    mapConnection: "Documents a Southtown municipal market for slag aggregate. It does not identify a particular placement or radiologically elevated batch.",
    url: "https://www.boston-ny.com/uploads/7/8/9/7/78977060/townboardminutes1983.pdf",
  },
  {
    id: "nysdec-tenorm-policy-2023",
    title: "Management of Soils Contaminated with TENORM - Program Policy Notice",
    ...
    geography: "Erie and Niagara",
    status: "final",
    establishes: "Explains that slag and other TENORM-containing ore-refining byproducts were historically used beneath roadways and other construction projects because of low cost and useful physical properties, without consideration of inherent radioactivity.",
    mapConnection: "Establishes the statewide historical mechanism and handling framework. It does not identify a specific WNY property as containing TENORM.",
    url: "https://dec.ny.gov/news/environmental-notice-bulletin/2023-07-05/statewide-program-policy-management-of-soils-contaminated-with-technologically-enhanced-naturally-occurring-radioactive-materials-tenorm",
  },
  {
