...
export const siteStories: Partial<Record<string, AtlasStory>> = {
  ...
  "former-signore": {
    ...
    timeline: [
      ...
      { period: "2008-2011", event: "A redevelopment owner acquired the property and entered it into the Brownfield Cleanup Program." },
      { period: "Early cleanup", event: "Underground storage tanks and associated petroleum-affected soil were removed, and an off-site soil-vapor investigation was completed." },
      { period: "2015", event: "DEC presented a proposed remedy for public comment." },
      { period: "Long-term phase", event: "Track 2 cleanup, cover and site-management requirements govern residual shallow soil and future excavation." },
    ],
    documentedImpacts: [
      "Petroleum-affected soil was associated with former underground tanks and required source removal.",
      "Chlorinated contaminants required groundwater, interceptor-well, town-well and soil-vapor evaluation.",
      "The 2015 public record reported long-term results at the interceptor and town wells as non-detect or below state drinking-water standards; that finding should be updated from current monitoring rather than treated as permanent.",
    ],
    cleanupAndControls: [
      "Underground tanks and petroleum-affected soil were removed as early source-control work.",
      "The completed Track 2 remedy allows restricted use while shallow soil remaining above unrestricted objectives is governed by cover, excavation procedures and site management.",
      "Groundwater and vapor monitoring remain pathway-specific safeguards rather than evidence of current exposure.",
    ],
    presentDay: [
      "Former Signore is a controlled Track 2 brownfield property. Its completed remedy and monitored water-supply protections should be described together: cleanup reduced and controlled sources, while long-term sampling verifies continued protectiveness.",
    ],
    researchNotes: [
      "Use local newspapers, directories, and company records to establish products, dates, and employment.",
      "Track current interceptor-well, town-well, groundwater and vapor results before repeating the 2015 monitoring conclusion as present-day fact.",
    ],
  },
  "former-nl-industries-foundry": {
    ...
    timeline: [
      ...
      { period: "Later industrial reuse", event: "The property transitioned to paper-recovery use while former foundry soil and fill remained an environmental concern." },
      { period: "2005", event: "The property entered the Brownfield Cleanup Program and a remedy was selected for contaminated soil." },
      { period: "2009", event: "Remedial construction was completed and documented in the final engineering report." },
      { period: "Present", event: "Industrial reuse continues subject to the cover, easement and site-management requirements." },
    ],
    documentedImpacts: [
      "Lead was the principal elevated soil contaminant highlighted in DEC's completion notice.",
      "Foundry sand, other metals and industrial fill were evaluated as part of the former brass-casting property.",
  ...
  "former-mill-no-2": {
    lastReviewed: "August 4, 2026",
    background: [
      "Former Mill No. 2 occupied roughly 18 acres between Royal Avenue, 47th Street, power-authority land, and the neighboring Norampac operation. DEC records describe approximately 661,980 square feet of interconnected concrete and masonry buildings constructed in stages from 1923 through 1974 for paper manufacturing, finishing, and packaging.",
      "The mill had been inactive since 1982. By the cleanup period, parts of the complex had collapsed or developed structural distress, a significant fire had worsened the deterioration, and asbestos-containing building materials were present. The subsurface also contained historic fill made up of crushed stone, concrete, slag, brick, sand, and other material.",
      "Investigation identified conventional industrial contamination and localized areas of elevated radiation within portions of the historic fill. The reviewed DEC records document discovery, delineation, screening, excavation, and disposal of the radiologically affected material, but they do not establish who originally produced it or when it was placed at the mill. WNY Atlas therefore does not assign that material to a particular company or federal program.",
      "Demolition and soil excavation cleared the obsolete complex for construction of the Greenpac recycled-paperboard mill. The project is an example of industrial redevelopment after a large mixed chemical and radiological cleanup, with continuing controls tied to industrial use.",
    ],
    timeline: [
      { period: "1923–1974", event: "Successive mill buildings were constructed for paper manufacturing, finishing, and packaging operations." },
      { period: "1982", event: "The former mill became inactive; the unused complex later deteriorated and suffered structural damage and a significant fire." },
      { period: "2010–2011", event: "Interim remedial measures demolished the former mill, Building 10, and the wastewater pretreatment plant so the subsurface could be investigated and redeveloped safely." },
      { period: "July–December 2011", event: "Excavation removed chemical hot spots, historic fill, and radiologically affected soil while foundations were prepared for the new mill." },
      { period: "June 2012", event: "DEC issued the Brownfield Cleanup Program Certificate of Completion after the removal program achieved the approved industrial cleanup objectives." },
      { period: "Present", event: "Greenpac operates a recycled-paperboard manufacturing facility on the remediated industrial property under an environmental easement and site-management requirements." },
    ],
    documentedImpacts: [
      "Soil and historic fill contained polycyclic aromatic hydrocarbons, arsenic, manganese, mercury, antimony, and localized volatile organic compounds above applicable cleanup criteria.",
      "Localized radiologically affected fill required specialized walkover surveys, field screening, excavation, transportation controls, and disposal at a permitted out-of-state facility.",
      "DEC reported that volatile organic compounds detected in overburden groundwater along the eastern boundary were associated with the adjacent Frontier Chemical Royal Avenue site. That finding is a documented neighboring-site relationship, not evidence that the two regulatory sites share one boundary or remedy.",
      "The radiological findings were bounded areas within the cleanup property. They should not be generalized to the surrounding Niagara Falls neighborhood, and their original source remains unresolved in the records reviewed for this update.",
    ],
    cleanupAndControls: [
      "The deteriorated mill complex was demolished, and excavation removed soil and fill exceeding the industrial cleanup objectives from the accessible remediation areas.",
      "Project records report approximately 135,839 tons of contaminated soil disposed at permitted local landfills, 67,827 tons of soil meeting the approved reuse criteria sent for reuse, and 20,087 tons of radiologically affected soil shipped to a permitted facility in Michigan.",
      "A site-wide radiological survey and field screening guided removal until DEC-approved excavation criteria were met. Confirmation sampling and construction documentation addressed the chemical excavation areas.",
      "The environmental easement limits the property to industrial use, restricts groundwater use, prohibits agriculture and vegetable gardens, and requires compliance with the approved Site Management Plan and future-excavation procedures.",
    ],
    presentDay: [
      "Former Mill No. 2 is now part of the operating Greenpac mill property. DEC considers the Brownfield Cleanup Program remedy complete for its approved industrial use, with the environmental easement, pavement and buildings, excavation procedures, and periodic certification preserving the assumptions behind that conclusion.",
    ],
    researchNotes: [
      "Continue searching archival property, railroad, mill, and fill records for the origin and placement date of the radiologically affected material; do not infer a source from material appearance or proximity alone.",
      "Add the mill's ownership, product, employment, and labor history from company records, city directories, newspapers, and Niagara Falls archives.",
      "Check the newest periodic review for easement compliance, cover condition, and any later subsurface work at the operating Greenpac facility.",
    ],
  },
  "tonawanda-plastics": {
    lastReviewed: "August 17, 2026",
    background: [
      "The 17.446-acre property at 3821 River Road was developed by Allied Fibers and Plastics in the early 1950s. The plant polymerized ethylene into low-molecular-weight polyethylene sold in powder, pellet and solid forms and operated until chemical processing ended in 1982.",
      "Rouse Breihan acquired the property in 1985. Later uses included management and laboratory testing for Tonawanda Coke and truck maintenance and parking; the property has been vacant since 2019 and changed ownership in 2022.",
    ...
    timeline: [
      { period: "Early 1950s-1982", event: "Allied Fibers and Plastics manufactured polyethylene and related products at 3821 River Road." },
      { period: "1985 onward", event: "Rouse Breihan acquired the property; later activities included Tonawanda Coke laboratory work and trucking uses rather than plastics production." },
      { period: "2019", event: "The industrial property became vacant." },
      { period: "2022-2023", event: "A new owner entered the 17.446-acre parcel into the Brownfield Cleanup Program and DEC approved a remedial-investigation work plan." },
      { period: "Current investigation", event: "The program is evaluating soil, sediment, groundwater, tanks, drums, piping and former process equipment before selection of a final parcel-specific remedy." },
    ],
    documentedImpacts: [
      "Historical records and earlier sampling justify investigation of former chemical-processing infrastructure, storage areas, industrial fill, soil, sediment and groundwater.",
    ...
    cleanupAndControls: [
      "The approved investigation is designed to distinguish on-site source areas from regional fill and neighboring properties and to complete a qualitative exposure assessment.",
      "Any interim action, cover, vapor measure, groundwater treatment or institutional control must follow the investigation and public remedy-selection process; the atlas does not describe a proposed control as already constructed.",
    ],
    presentDay: [
      "Tonawanda Plastics is an active investigation and redevelopment property, not a completed cleanup. Its former plastics plant, later Tonawanda Coke support uses, and nearby Site 109 remain related history but legally and evidentially distinct records.",
    ],
    researchNotes: [
      "Track sampling results and the eventual alternatives analysis before naming final contaminants of concern or remedy components.",
  ...
  "hooker-102nd-street-landfill": {
    ...
    background: [
      ...
      "The river pathway is historical fact, not merely a proximity concern. EPA's remedial investigation identified groundwater discharge from landfill fill and alluvium into the embayment as the principal off-site migration route, and sediment contamination extended to an area within roughly 300 feet of shore. Contemporary reporting in 1993 recorded health officials warning about substances still leaking into the river while the final remedy was being designed.",
      "Later monitoring documents a changed condition. EPA's May 2026 five-year review retained the 2017 conclusion that site-related contamination was not migrating toward the Niagara River, while continuing to find stable residual contamination in several monitoring wells outside the slurry wall. The historical release and the current containment finding belong in the same story, each labeled by date.",
    ],
    timeline: [
      { period: "1943-1971", event: "Hooker and Olin operated adjoining disposal areas for bulk liquid and solid chemical wastes." },
      { period: "December 1970", event: "The U.S. Army Corps of Engineers inspected the property, cited disposal practices under the Rivers and Harbors Act, and the companies stopped further landfilling." },
      ...
      { period: "August 1993", event: "Contemporary Buffalo News reporting preserved state health officials' warning that cancer-linked substances were still leaking from the landfill into the Niagara River before construction of the modern containment system." },
      ...
      { period: "2017-2026", event: "Surface-water and sediment testing found no site-related contaminants in sampled surface water and sediment results below the cited Class A guidance values; EPA's 2026 review continued to regard that river-migration conclusion as valid." },
    ],
    documentedImpacts: [
      ...
      "Several VOCs, SVOCs, and pesticides remained above state groundwater criteria in four perimeter overburden wells during 2020-2025; EPA interpreted the stable detections as residual contamination outside the wall rather than evidence of a new wall breach.",
      "State-led 2019 emerging-contaminant sampling found 1,4-dioxane above New York's later drinking-water value in several sampled wells. EPA's 2026 review suggested adding it to the groundwater monitoring program. PFAS detections were not interpreted as a significant site source.",
    ...
    cleanupAndControls: [
      ...
      "Monitoring includes quarterly hydraulic measurements at ten paired locations, quarterly checks at eight NAPL recovery wells, and annual VOC, SVOC, and pesticide sampling from ten overburden and three bedrock wells.",
      "From 2020 through 2025, the system recovered 520,812 gallons of aqueous-phase leachate for treatment. From 2021 through 2025, operators recovered 2,834.8 gallons of NAPL for off-site management.",
    ],
    presentDay: [
      "The landfill remains a contained-waste remedy beside the Niagara River. EPA's May 2026 review found the remedy protective and the cap in excellent condition. It noted no formal issues, but suggested evaluating one well pair if outward-gradient events continue and adding 1,4-dioxane to routine groundwater monitoring.",
      "EPA deletion in 2004 recorded a completed remedy, not unrestricted soil or removal of the waste mass; protectiveness depends on the cap, wall, recovery, testing, and institutional controls continuing to work.",
    ],
    researchNotes: [
      "Map the exact landfill boundary rather than using the point as a proxy for surrounding riverfront land.",
      "Add a dated monitoring diagram showing the well pairs, recovery wells, former sediment-removal area, embayment, Little Niagara River, and adjacent former Griffon Park municipal landfill without merging those properties.",
      "Continue searching Buffalo District Army Corps archives for inspection correspondence or sediment work. The reviewed record documents a 1970 Corps inspection, while later site testing is conducted under EPA and DEC oversight by the responsible parties and their contractors.",
    ],
  },
  "griffon-park-landfill": {
    lastReviewed: "August 17, 2026",
    background: [
      "Griffon Park occupies about 10.22 acres beside the Little Niagara River. DEC's newest chronology says the property was wetland before 1938, the City of Niagara Falls used it for refuse disposal from 1949 to about 1953, and intermittent tree burning and disposal of municipal-incinerator residues and other noncombustibles continued into the early 1970s. The city developed the filled land as a park in the mid-1970s.",
      "The former municipal dump is immediately west of the separately owned Hooker/Olin 102nd Street chemical landfill. Historical aerials show one broad altered river-edge landscape, but that appearance does not establish one shared pit, operator, or waste inventory. Government records consistently describe adjoining disposal properties with different histories.",
      "DEC's 2021 work plan recorded occasional exposed waste along the tributary bank and pooled leachate near the boat launch. Five wells and one seep were sampled in March 2022 under the state's Inactive Landfill Initiative; fill containing glass, metal, cloth, brick, cinder, and wood extended roughly 5 to 17 feet below ground in the five borings.",
      "Orange-red seeps near the launch have been reported repeatedly since at least 2003. The appearance prompted new public concern in 2024 and 2026. DEC attributes the material to iron-rich groundwater reaching the surface through poorly drained ground, where naturally occurring bacteria oxidize the dissolved iron.",
    ],
    timeline: [
      { period: "Before 1938", event: "Historical records reviewed by DEC describe the future park property as wetland." },
      { period: "1949-about 1953", event: "The City of Niagara Falls used the property for municipal refuse disposal." },
      { period: "1953-early 1970s", event: "Intermittent burning of trees and disposal of municipal-incinerator residue and other noncombustibles reportedly continued." },
      { period: "Mid-1970s", event: "The city developed the filled property into Griffon Park." },
      { period: "1993-1994", event: "A state preliminary assessment found no significant hazardous-waste threat attributable to Griffon, and DEC removed it from the inactive hazardous-waste registry." },
      { period: "March 2022", event: "DEC installed and sampled five monitoring wells and sampled the boat-launch seep under the Inactive Landfill Initiative." },
      { period: "May 2024", event: "Visible orange staining brought renewed news coverage; DEC again attributed it to elevated iron." },
      { period: "June-July 2026", event: "DEC sampled seep material and groundwater after renewed complaints and published a detailed July 29 evaluation." },
    ],
    documentedImpacts: [
      "Municipal fill occupies much of the park, and 2022 borings encountered refuse-related material at depths of approximately 5 to 17 feet.",
      "DEC's 2021 work plan documented occasional exposed waste along the tributary bank and pooled leachate near the boat launch.",
      "In June 2026 seep material, barium and cadmium slightly exceeded the commercial soil cleanup objectives DEC used as a screening comparison; DEC stressed that those soil criteria are not directly applicable to seep material and judged the exceedances minor.",
      "The June 2026 groundwater sample exceeded state groundwater values for several common regional metals as well as lead and alpha-BHC. DEC noted that the groundwater is not used for drinking and predicted rapid dilution if it reaches the Little Niagara River.",
      "The July 2026 evaluation used unvalidated laboratory results. DEC said validation was not expected to change its overall conclusion, while acknowledging that individual values could change.",
    ],
    cleanupAndControls: [
      "The former disposal area is covered by the developed and vegetated park surface; DEC described the cap as well vegetated and without visible subsidence or erosion in its 2021 work plan.",
      "Five monitoring wells installed in 2022 provide site-specific groundwater data. The same investigation sampled the recurring seep near the launch.",
      "DEC has investigated recurring orange staining since at least 2003 and sampled seep material and nearby groundwater again in June 2026 for VOCs, SVOCs, pesticides, PCBs, PFAS, metals, and general leachate indicators.",
      "The adjacent 102nd Street landfill has its own slurry wall, cap, leachate and NAPL recovery, monitoring network, and federal five-year reviews; those controls should not be presented as Griffon Park's remedy.",
    ],
    presentDay: [
      "Griffon remains an operating public park, playground, and boat and kayak launch over a former municipal disposal area. DEC's July 2026 conclusion was that the orange seep reflects groundwater upwelling, iron, and naturally occurring bacteria—not significant chemical contamination requiring further action.",
      "That conclusion does not mean the site contains no landfill-related constituents. DEC expressly reported low-level constituents in subsurface soil and groundwater and specific 2026 exceedances; its risk conclusion depends on concentrations, exposure setting, groundwater use, and expected river dilution.",
    ],
    researchNotes: [
      "Locate an exact, reproducible 1938 aerial frame and compare the pre-fill wetland boundary with the 1958 USGS image and later orthophotos.",
      "Track publication of validated June 2026 laboratory data and record any change to DEC's July 29 evaluation.",
      "Request or locate sampling records from 2003, 2004, 2016, and other reported seep investigations so the long-term pattern can be compared on one table.",
      "Keep Griffon Park, 102nd Street, and Love Canal evidence separated by property, sample location, date, and responsible program even when news accounts discuss them together.",
    ],
  },
  ...
  "anderson-cleaners-jamestown": {
    lastReviewed: "August 17, 2026",
    background: [
      "The 2.4-acre property at 5 Hunt Road first held a towel factory in the 1930s. Anderson Cleaners occupied it by the mid-1940s and used Stoddard solvent from about 1947 to 1978, storing it in two approximately 1,100-gallon underground tanks later removed.",
      "A 1985 fire destroyed about 8,000 square feet of the building. The dry-cleaning area was not directly burned, but the official work plan records heat-damaged equipment and extensive firefighting water entering that portion of the building.",
    ...
    timeline: [
      { period: "1930s-mid-1940s", event: "A towel factory preceded Anderson Cleaners at the Hunt Road property." },
      { period: "About 1947-1978", event: "The cleaner used Stoddard solvent stored in two underground tanks; chlorinated dry-cleaning chemicals were also part of the operating history." },
      { period: "1985", event: "A major fire damaged the building and firefighting water entered the dry-cleaning area before reconstruction." },
      { period: "2004-2005", event: "The Brownfield Cleanup Program investigation installed borings and wells and documented chlorinated VOCs in soil and groundwater." },
      { period: "2012 onward", event: "The remedy advanced through dense-product removal, in-ground treatment, groundwater monitoring and soil-vapor evaluation." },
