...
export const fernBrookCurrentRoute: {
  recordId: string;
  name: string;
  coordinates: [number, number][];
  sourceUrl: string;
  ...
  recordId: "fern-brook-managed-outlet",
  name: "Current mapped Fern Brook course",
  coordinates: [
    [-79.0676916, 42.6356441],
    [-79.0675728, 42.6359295],
    [-79.067424, 42.6362533],
    [-79.0672531, 42.6364838],
    [-79.0671195, 42.6367253],
    [-79.0670005, 42.637093],
    [-79.0671417, 42.6378065],
    [-79.067008, 42.6384651],
    [-79.066837, 42.6387175],
    [-79.0667999, 42.6390029],
    [-79.0670007, 42.6393597],
    [-79.0670006, 42.6397987],
    [-79.0658188, 42.6408415],
    [-79.065633, 42.6410226],
    [-79.0655141, 42.6411872],
    [-79.0653653, 42.6414452],
    [-79.0652838, 42.6424221],
    [-79.0652688, 42.6427294],
    [-79.0655365, 42.6429544],
  ],
  sourceUrl:
    "https://hydro.nationalmap.gov/arcgis/rest/services/nhd/MapServer/6",
  sourceLabel: "USGS National Hydrography Dataset flowline",
  explanation:
    "The Town drainage study maps Fern Brook crossing Route 5, residential streets, Waterman Road, Evans Town Park and Lake Shore Road before reaching Lake Erie. This solid-blue reference follows the current USGS hydrography centerline through the lower study corridor.",
};
